...
const FAQS = [
  ...
  {
    question: "기존 런치 플랫폼과 어떻게 다른가요?",
    answer:
      "기존 메이커 플랫폼들은 대부분 '런치 이벤트' 형태입니다. 하루 주목받기 위해 미리 팔로워와 네트워크를 준비해야 하고, 이벤트가 끝나면 빠르게 잊혀집니다. 마이프로덕트는 '연재형 플랫폼'입니다. 제품이 업데이트될 때마다 타임라인에 기록이 쌓이고, 동료 메이커와 1:1로 진지한 피드백을 교환합니다. 팔로워 없이도 시작할 수 있고, 홍보보다 성장에 집중합니다.",
  },
  {
  ...
  return (
    <>
      ...
      <article className="mx-auto max-w-2xl px-4 py-12 sm:px-6">
        ...
        {/* ── 차별화 포지셔닝 ── */}
        <section className="mb-14">
          <h2 className="mb-5 text-[22px] font-extrabold tracking-tight">런치 이벤트가 아니라 연재형 플랫폼</h2>
          <p className="mb-5 text-[15px] leading-relaxed text-ink-60">
            기존 런치 사이트는 하루 이벤트 형식입니다. 그 하루를 위해 사전 마케팅이 필요하고, 타이밍을 놓치면 빠르게 잊혀집니다. 짧은 응원 반응은 많지만, 진지한 피드백이나 작품의 만든 시점을 증명하는 기능은 부족합니다.
          </p>
          <p className="text-[15px] leading-relaxed text-ink-60">
            마이프로덕트는 만들고, 올리고, 피드백 받고, 개선하고, 다시 올리는 <strong className="text-ink">연재형 플랫폼</strong>입니다. 팔로워 없어도 시작할 수 있고, 제품이 자라는 과정이 타임라인으로 남습니다. 등록 즉시 영구 보존되는 증명서가 발급되고, 10문항 구조화된 피드백을 통해 메이커가 실제로 활용할 수 있는 인사이트를 받습니다.
          </p>
        </section>
